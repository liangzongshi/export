...
mongoose.connect('mongodb://localhost/finfine',{ useNewUrlParser: true, useUnifiedTopology: true, useFindAndModify: false, useCreateIndex: true })
...
const schemaUser = new Schema({
    ...
    info: {
        ...
        tlgToken: {type: String, default: null}
    },
    // Bảo mật
    secure: {
...
const schemaSystem = new Schema({
    totalFund: {type: Number, default: 9},
    totalToken: {type: Number, default: 100},
